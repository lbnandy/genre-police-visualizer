...
- Suspended rendering, audio analysis and local-model feeds, pointer hit testing, and adaptive backdrop sampling while the main window is hidden or minimized, with automatic recovery when it becomes visible; active recording continues at full priority.
