...
const GROUPS = [
  ...
  ['Jazz', 'jazz', ['ジャズ', 'ビバップ', 'スウィング']],
  ['Bossa Nova', 'jazz', ['ボサノバ', 'ボサノヴァ']],
  ['Classical', 'classical', ['クラシック', 'オーケストラ', 'オペラ', '室内楽', 'ピアノ']],
  ...
  ['R&B/Soul', 'rnb', ['R&B／ソウル', 'R&B/ソウル', 'R＆B', 'ソウル', 'ネオソウル']],
  ['Pop', 'pop', ['ポップ', '팝']],
  ...
  ['Ambient', 'electronic', ['アンビエント']],
  ['IDM', 'electronic', ['IDM', 'インテリジェントダンスミュージック']],
  ['Downtempo', 'electronic', ['ダウンテンポ']],
  ...
  ['Gospel', 'rnb', ['ゴスペル', 'クリスチャン／ゴスペル', 'クリスチャン/ゴスペル']],
  ['Comedy', 'pop', ['コメディ']],
...
const JAPANESE_FALLBACKS = [
  ...
  [/ジャズ|スウィング/, { canonical: 'Jazz', baseId: 'jazz' }],
  [/クラシック|オペラ|交響曲/, { canonical: 'Classical', baseId: 'classical' }],
